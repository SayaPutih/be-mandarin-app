...
} from "../../../service/student/class/studentClass.service.js";
...
export const GetAssignmentsByClassController = async (req, res) => {
  ...
  const data = await getAssignmentsByClassService(
    classId,
    studentId,
    page,
    limit,
...
export const GetAssignmentCardsController = async (req, res) => {
  ...
  const cards = await getAssignmentCardsService(assignmentId);
